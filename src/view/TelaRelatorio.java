	...
	public TelaRelatorio() {
		...
		lblGerar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				if ((textFieldDateInicio.getText().equals("dd-MM-yyyy")
						|| textFieldDateInicio.getText().equals("") && textFieldDateFim.getText().equals("dd-MM-yyyy")
						|| textFieldDateInicio.getText().equals("")) && chckbxFone.isSelected() == false
						&& chckbxremoto.isSelected() == false && chckbxlocalSistema.isSelected() == false
						&& chckbxchamadosDoDia.isSelected() == false
					...
					try {
						...
						lblLocalSistema
								.setText(relatorio.quantLocalSistema()[0] + " " + relatorio.quantLocalSistema()[1]);
						labelUsuarioMaiorInter.setText(relatorio.quantUsuarioMaiorInteracao()[0] + " "
								+ relatorio.quantUsuarioMaiorInteracao()[1]);
					...
					if (relatorio.validaData(textFieldDateInicio.getText(), textFieldDateFim.getText())) {
						relatorio.listaChamadoData(textFieldDateInicio.getText(), textFieldDateFim.getText());
						boolean fone = false;
						...
						try {
							labelTotal.setText(Integer
									.toString(relatorio.total(fone, remoto, localSistema, chamadoDia, usuarioMaior)));
