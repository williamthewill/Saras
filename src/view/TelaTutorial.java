...
public class TelaTutorial extends JDialog {
	...
	public TelaTutorial() {
		...
		txtpnF.setText(
				"O SARAS(Sistema de Automa\u00E7\u00E3o de Registro de Atendimento Simples), vai ajudar voc\u00EA a ganhar mais tempo no seu dia-a-dia, automatizando todo o processo de salvamento de atendimentos, gera\u00E7\u00E3o de rel\u00E1tario, gera\u00E7\u00E3o de backup, cadastro de chamados no portal do SOS e envio de chamado para Softplan.");
		...
		txtpnVamosComearPrimeiro.setText(
				"*Vamos come\u00E7ar, primeiro voc\u00EA deve se cadastrar, clique no bot\u00E3o \"Cadastre-se\", do sistema.");
		...
		okButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				txtpnF.setText(
						"*Muito bem, agora na tela de Cadastro insira o mesmo usuario e senha do portal do SOS. Depois clique no botão SALVAR, do sistema.");
